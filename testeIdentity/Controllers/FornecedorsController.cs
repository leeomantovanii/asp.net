...
namespace testeIdentity.Controllers
{
    public class FornecedorsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "id,nome,razaoSocial,cidade,endereco,estado,status")] Fornecedor fornecedor)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "id,nome,razaoSocial,cidade,endereco,estado,status")] Fornecedor fornecedor)
        {
            if (ModelState.IsValid)
            {
